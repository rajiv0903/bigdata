package com.practice.bigdata.hadoop.mapreduce.advance.sequence_file;
...
public class BinaryFilesToHadoopSequenceFile {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 2) {
			System.out.println("Usage: <Input Directory path having list of file> <Output Sequence Directory Path>");
		}
		Configuration conf = new Configuration();
